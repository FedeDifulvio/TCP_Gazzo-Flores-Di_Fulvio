        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6" style="padding:0px 70px">
                    <asp:Label ID="labelTitulo" CssClass="labels" Text="Alta Especialidad" runat="server" />
                    <br />
                    <br />
                    ...
                    <tbody>
                        <%foreach (Dominio.Especialidad item in ListaEspecialidades) { 
                                ...
                                %>   
                                    <tr >
                                         <th><%= item.Nombre %> </th>                                   
                                         <th>  <a href="../Especialidades/Especialidades.aspx?id=<%=item.ID %>&action=mod"> <img style="width:30px; height:30px;" src="../img/edit.png" alt="Alternate Text" /></a> </th> 
                                          <th> <span  onClick="crearModal(<%=item.ID %>,'../Especialidades/Especialidades.aspx')" ><img class="openModalEliminar" style="width:30px; height:30px;" src="../img/remove.png" alt="Alternate Text" /></span> </th> 
                                    </tr>
                                 <%
